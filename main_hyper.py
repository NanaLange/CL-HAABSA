...
def lcr_objective(hyperparams):
    ...
    eval_num += 1
    (learning_rate, keep_prob, momentum) = hyperparams
    print(hyperparams)
    tf.reset_default_graph()
    l = lcrModelAlt_hierarchical_v4_hyper_opt.main("data\programGeneratedData\curriculumLearning\curriculumhypertraindata_2016_10_10.txt",
                                                   "data\programGeneratedData\curriculumLearning\curriculumhyperevaldata_2016_10_10.txt", accuracyOnt, test_size, remaining_size, learning_rate, keep_prob, momentum, l2=0.0001)
    tf.reset_default_graph()
