...
# used when optimizing based on buckets
import os, sys
...
def main(train_path, test_path, accuracyOnt, test_size, remaining_size, learning_rate=0.09, keep_prob=0.3,
    ...
    with tf.Session(config=config) as sess:
        ...
        while i < FLAGS.n_iter and converged == False:
            ...
            print('all samples={}, correct prediction={}, training time={}, training time so far={}'.format(cnt, acc,
                                                                                                            elapsed_time,
                                                                                                            train_time))
            ...
            print('Iter {}: mini-batch loss={:.6f}, train loss={:.6f}, train acc={:.6f}, test acc={:.6f}'.format(i,
                                                                                                                 cost,
                                                                                                                 trainloss,
                                                                                                                 trainacc,
                                                                                                                 acc))
        ...
        print(
            'Optimization Finished! Iteration:{}:Minimal test loss={}, test accuracy={}'.format(max_iter, max_testloss,
                                                                                                max_testacc))
