...
nltk.internals.config_java('C:/Program Files/Java/jre1.8.0_251/bin/java.exe')
java_path = 'C:/Program Files/Java/jre1.8.0_251/bin/java.exe'
os.environ['JAVAHOME'] = java_path
owlready2.JAVA_EXE = 'C:/Program Files/Java/jre1.8.0_251/bin/java.exe'
...
class OntReasoner():
    ...
    def run(self, use_backup, path, use_svm, cross_val = False, j = 0):
        ...
        # Save the outputs to cross_train_10.txt file
        if use_backup == True:
        ...
        if cross_val:
            if use_backup == True:
                print(self.remaining_pos_vector)
                outF= open("data/programGeneratedData/crossValidation"+str(FLAGS.year)+'/cross_val_remainder_'+str(j)+'cross_train_10.txt', "w")
                with open(FLAGS.test_path, "r") as fd:
                    for i, line in enumerate(fd):
                        if i in self.remaining_pos_vector:
                            outF.write(line)
            ...
            if use_svm == True:
                print(self.remaining_pos_vector)
                outF= open("data/programGeneratedData/crossValidation"+str(FLAGS.year)+'/svm/cross_val_remainder_'+str(j)+'cross_train_10.txt', "w")
                with open(FLAGS.test_svm_path, "r") as fd:
                    for i, line in enumerate(fd):
                        if i in self.remaining_pos_vector:
                            outF.write(line)
